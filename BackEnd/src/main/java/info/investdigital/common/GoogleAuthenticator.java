...
/**
 * @Author: Gaoyp
 * @Description: google secret utils
...
public class GoogleAuthenticator {
	...
	public static final String SEED = "n9GjOvTbW5oVSV7avL98763814reyhrenyvretredLDVKs9m0QD7vxRs2im5MDaNCWGmcD2xvcZx";
	// Java实现随机数算法
	...
	public static String getQRBarcodeURL(String user, String host, String secret) {
		String format = "http://www.google.com/chart?chs=200x200&chld=M%%7C0&cht=qr&chl=otpauth://totp/%s@%s?secret=%s&issuer=InvestDigital";
	...
	public static String getQRBarcode(String user, String secret) {
		String format = "otpauth://totp/%s?secret=%s&issuer=InvestDigital";
